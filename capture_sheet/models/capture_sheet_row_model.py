...
class CaptureSheetRowModel(CaptureSheetBaseModel):
    ...
    not_null: Optional[bool | None] = Field(default = None, validation_alias="column_not_null")
    is_unique: Optional[bool | None] = Field(default = None, validation_alias="column_is_unique")
